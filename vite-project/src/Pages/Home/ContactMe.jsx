            ...
            <div className="container">
              ...
              <label htmlFor="choose-topic" className="contact--label">
                  ...
                  <label htmlFor="message" className="contact--label">
                    ...
                    <textarea  className="contact--input text-md" name="message" rows={8} placeholder="Type your message..." />
                </label>
                <label htmlFor="checkbox" className="checkbox--label">
                    <input type="checkbox" require name="checkbox" id="checkbox" />
                    <span>
                        I accept the terms
                    </span>
                </label>
